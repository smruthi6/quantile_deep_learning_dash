...
def load_data(model_name):
    datasets = {}
    try:
        datasets[model_name] = pd.read_csv(f'ethereum_{model_name}_data.csv', parse_dates=['Date'])
...
def main():
    st.title('Cryptocurrency Close Price Dashboard: Ethereum')
    ...
    datasets = load_data(model_value)
